  ...
  function CompositeEditor(columns, containers, options) {
    ...
    function editor(args) {
      ...
      this.destroy = function () {
        ...
        while (idx--) {
          if (editors[idx]) editors[idx].destroy();
        }
      ...
      this.isValueChanged = function () {
        var idx = editors.length;
        while (idx--) {
          if (editors[idx] && editors[idx].isValueChanged()) {
            return true;
          }
        }
        return false;
      ...
      this.serializeValue = function () {
        ...
        var idx = editors.length;
        while (idx--) {
          if (editors[idx])  serializedValue[idx] = editors[idx].serializeValue();
        }
      ...
      this.applyValue = function (item, state) {
        var idx = editors.length;
        while (idx--) {
          if (editors[idx])  editors[idx].applyValue(item, state[idx]);
        }
      };
      ...
      this.loadValue = function (item) {
        var idx = editors.length;
        while (idx--) {
          if (editors[idx]) editors[idx].loadValue(item);
        }
      };
      ...
      this.validate = function () {
        ...
        var idx = editors.length;
        while (idx--) {
          if (editors[idx]) validationResults = editors[idx].validate();
      ...
      this.hide = function () {
        var idx = editors.length;
        while (idx--) {
          if (editors[idx]) editors[idx].hide && editors[idx].hide();
        }
      ...
      this.show = function () {
        var idx = editors.length;
        while (idx--) {
          if (editors[idx]) editors[idx].show && editors[idx].show();
        }
